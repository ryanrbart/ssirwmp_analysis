...
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="canesm2") 
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="ccsm4") 
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="cnrm") 
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="hadgemcc") 
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="hadgemec") 
vic_map(tib=vic_maps_swe, border=ss_border, flux_type = "swe", flux_name = "Snow Water Equivalent", gcm_input="miroc5") 
