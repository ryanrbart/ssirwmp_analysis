...
ggplot() + 
  ...
  labs(title = "Projected Annual Streamflow", x = "Period", y = "Annual Streamflow (mm)") +
  ...
  theme_bw()
ggsave("output/Q_box_annual.jpg", width = 4, height = 3)

# Changes in Q
ggplot() + 
  geom_boxplot(data=etqswe_annual_by_fp, aes(future_period, Q_annual_diff, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Change in Annual Streamflow", x = "Period", y = "Change in Annual Streamflow (mm)") +
...
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, Q, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Monthly Streamflow", x = "Period", y = "Monthly Streamflow (mm)") +
  ...
  theme_bw()
ggsave("output/Q_box_month.jpg", width = 8, height = 6)

# Changes in Q
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, Q_month_diff, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Change in Monthly Streamflow", x = "Period", y = "Change in Monthly Streamflow (mm)") +
  geom_hline(yintercept = 0) +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~month, labeller = as_labeller(month_id)) +
  theme_bw()
...
ggplot() + 
  geom_boxplot(data=etqswe_season_by_fp, aes(future_period, Q, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Seasonal Streamflow", x = "Period", y = "Seasonal Streamflow (mm)") +
...
ggplot() + 
  geom_boxplot(data=etqswe_season_by_fp, aes(future_period, Q_season_diff, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Change in Seasonal Streamflow", x = "Period", y = "Change in Seasonal Streamflow (mm)") +
  geom_hline(yintercept = 0) +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~season, labeller = as_labeller(season_id)) +
  theme_bw()
...
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, ET, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Monthly ET", x = "Period", y = "Monthly ET (mm)") +
...
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, ET_month_diff, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Change in Monthly ET", x = "Period", y = "Change in Monthly ET (mm)") +
  geom_hline(yintercept = 0) +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~month, labeller = as_labeller(month_id)) +
  theme_bw()
...
ggplot() + 
  geom_boxplot(data=etqswe_season_by_fp, aes(future_period, ET, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Seasonal ET", x = "Period", y = "Seasonal ET (mm)") +
  geom_hline(data=etqswe_season_by_fp, aes(yintercept = ET_hist_season2), color="gray20") +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~season, labeller = as_labeller(season_id)) +
  theme_bw()
ggsave("output/ET_box_season.jpg", width = 5, height = 4)
...
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, SWE, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Monthly Peak Snow Water Equivalent (SWE)", x = "Period", y = "Monthly Peak SWE (mm)") +
  geom_hline(data=etqswe_month_by_fp, aes(yintercept = SWE_hist_month2), color="gray20") +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~month, labeller = as_labeller(month_id)) +
  theme_bw()
ggsave("output/SWE_box_month.jpg", width = 8, height = 6)

# Changes in SWE
ggplot() + 
  geom_boxplot(data=etqswe_month_by_fp, aes(future_period, SWE_month_diff, fill=rcp),
               color="black", outlier.shape = NA) +
  labs(title = "Projected Change in Monthly Peak Snow Water Equivalent (SWE)", x = "Period", y = "Change in Monthly Peak SWE (mm)") +
  geom_hline(yintercept = 0) +
  scale_fill_discrete(name="RCP", labels = c("4.5","8.5")) +
  facet_wrap(~month, labeller = as_labeller(month_id)) +
  theme_bw()
